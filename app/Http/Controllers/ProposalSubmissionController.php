...
class ProposalSubmissionController extends Controller
{
    public function store(Request $request)
    {
        ...
        try {
            ...
            // $application_file = $request->file('application_file')->store('public/application_file');
            // $proposal_file = $request->file('proposal_file')->store('public/proposal_file');
            // $anggaran_file = $request->file('anggaran_file')->store('public/anggaran_file');
            ...
            $dataSubmit = [
                ...
                'proposal' => 'Jenis Penelitian : Penelitian TA',
    ...
    public function showAllUser()
    {
        ...
        $non_ta_submission = ProposalNonTASubmission::where('user_id', auth()->user()->id)
            ->orderBy('id', 'DESC')
            ->with('user')
            ->get();

        $industri_submission = ProposalIndustriSubmission::where('user_id', auth()->user()->id)
            ->orderBy('id', 'DESC')
            ->with('user')
            ->get();
        ...
        $data = [
            'submission' => $submission,
            'non_ta_submission' => $non_ta_submission,
            'industri_submission' => $industri_submission
        ];
    ...
    public function showSuperAdmin()
    {
        ...
        $non_ta_submission = ProposalNonTASubmission::orderBy('id', 'DESC')
            ->with('user')
            ->get();

        $industri_submission = ProposalIndustriSubmission::orderBy('id', 'DESC')
            ->with('user')
            ->get();
